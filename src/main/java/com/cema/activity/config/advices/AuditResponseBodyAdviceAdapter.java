package com.cema.activity.config.advices;

import com.cema.activity.domain.audit.Audit;
import com.cema.activity.domain.security.CemaUserDetails;
import com.cema.activity.services.client.administration.AdministrationClientService;
...
public class AuditResponseBodyAdviceAdapter implements ResponseBodyAdvice<Object> {
    ...
    private static final String MODULE = "activity";
