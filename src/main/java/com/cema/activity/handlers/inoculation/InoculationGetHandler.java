...
@Service
public class InoculationGetHandler implements ActivityHandler<Inoculation, Inoculation> {
    private final Logger LOG = LoggerFactory.getLogger(InoculationGetHandler.class);
