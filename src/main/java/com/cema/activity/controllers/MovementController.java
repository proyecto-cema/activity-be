...
public class MovementController {
    ...
    @ApiOperation(value = "Retrieve a list of movements matching the sent data", response = Movement.class, responseContainer = "List")
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<Movement>> getMovements(
            ...
            @ApiParam(
                    value = "The batchName of the activity",
                    example = "batchName")
            @RequestParam(value = "batchName", required = false) String batchName,
            @ApiParam(
                    value = "The location name of the activity",
                    example = "10")
